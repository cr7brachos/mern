            ...
            <Row className="mt-4">
                ...
                <Col md={8}>
                    ...
                    <Row>
                        ...
                        <Row>
                            <Col>
                            <Alert variant="danger" className="mt-3">Not delivered</Alert>
                            </Col>
                            <Col>
                            <Alert variant="success" className="mt-3">Paid on 16-6-2023</Alert>
                            </Col>
                        </Row>
                    </Row>
                    <br />
                ...
                <ListGroup>
                    ...
                    <ListGroupItem >
                        <div className="d-grid gap-2">
                            <Button size="lg" variant="danger" type="button">Mark as delivered</Button>
                        </div>
